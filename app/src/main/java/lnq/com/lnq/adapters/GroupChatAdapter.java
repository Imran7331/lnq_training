...
import lnq.com.lnq.model.event_bus_models.EventBusPlayVoiceMessage;
import lnq.com.lnq.model.event_bus_models.EventBusPlayVoiceMessageGroup;
        ...
        if (chatData != null) {
            try {
                ...
                if (chatHolder.getItemViewType() == 0) {
                    ...
                    if (message.isEmpty() && chatData.getSharecontact() == null && chatData.getVoice_attachment() == null) {
...
//                            senderHolder.smartImageViewMessage.putImages(arr);
                    ...
                    } else if (!message.isEmpty() && !chatData.getAttachment().isEmpty() && chatData.getVoice_attachment() == null) {
                        senderHolder.textViewMessage.setVisibility(View.INVISIBLE);
                        senderHolder.imageViewMessage.setVisibility(View.GONE);
                        senderHolder.cardViewSharePrifile.setVisibility(View.GONE);
                        senderHolder.voiceLayout.setVisibility(View.GONE);
...
//                            senderHolder.textViewMutliTextMessage.setAutoLinkText(message);
                    ...
                    } else if (chatData.getSharecontact() != null && chatData.getVoice_attachment() == null) {
                        senderHolder.textViewTextMessage.setVisibility(View.GONE);
                        senderHolder.imageViewTextMessage.setVisibility(View.GONE);
                        senderHolder.textViewMessage.setVisibility(View.INVISIBLE);
                        senderHolder.imageViewMessage.setVisibility(View.GONE);
...
//    }
    ...
    class ChatSenderHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatImageView imageViewShareProfile, imageViewPlayRecording, imageViewStopRecording;
        AppCompatImageView img1, img2, img3, img4, img1Text, img2Text, img3Text, img4Text;
        ProgressBar progressBarVoiceNote;
        ...
        ChatSenderHolder(@NonNull View itemView) {
            ...
            imageViewStopRecording = itemView.findViewById(R.id.imageViewStopRecording);
...
//                BitmapFactory.decodeByteArray(fullImageAsBytes, 0, fullImageAsBytes.length);
            ...
            imageViewPlayRecording.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    imageViewPlayRecording.setVisibility(View.INVISIBLE);
                    imageViewStopRecording.setVisibility(View.VISIBLE);
                    EventBus.getDefault().post(new EventBusPlayVoiceMessageGroup(chatDataList.get(getBindingAdapterPosition()).getVoice_attachment(), "play"));
                }
            });

            imageViewStopRecording.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    imageViewPlayRecording.setVisibility(View.VISIBLE);
                    imageViewStopRecording.setVisibility(View.INVISIBLE);
                    EventBus.getDefault().post(new EventBusPlayVoiceMessageGroup(chatDataList.get(getBindingAdapterPosition()).getVoice_attachment(), "stop"));
                }
            });
        }
    ...
    class ChatReceiverHolder extends RecyclerView.ViewHolder {
        ...
        TextView textViewTime, textViewDate, textViewShareName, textViewShareProfile, textViewVoiceNoteTime;
        AutoLinkTextView textViewMessage;
