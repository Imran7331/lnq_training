...
//                intent.putExtra("profileImage","http://lnq.demo.leadconcept.net/uploads/chat_images/" + chatDataList.get(getAdapterPosition()).getAttachment());
            ...
            imageViewPlayRecording.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    EventBus.getDefault().post(new EventBusPlayVoiceMessage(chatDataList.get(getBindingAdapterPosition()).getVoice_attachment(), "play"));
                }
            });
            ...
            imageViewStopRecording.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    EventBus.getDefault().post(new EventBusPlayVoiceMessage(chatDataList.get(getBindingAdapterPosition()).getVoice_attachment(), "stop"));
                }
            });
        }
